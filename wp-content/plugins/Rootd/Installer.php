...
class Rootd_Installer 
{
	...
	const DOWNLOAD_URL 		= 'http://rickbuczynski.com/get-rootd-framework/download';
	...
	protected function _processStep()
	{
		...
		// Run step installation if requested
		else if($params['action'] == 'complete' && $this->_steps[$currentStep]->install())
		{
